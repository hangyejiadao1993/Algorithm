...
int main()
{
    ...
    int n, j = 0;
    std::cout << "Now Let's start this program! There is no tree in memory.\n";
    int item;
    while (item != 0)
    {
        std::cout << "\nRoot address = " << atree << "\n";
            ...
            if (atree != NULL)
                while (n != 3458)
                {
                    ...
                    if (n != 3458)
                    {
                        ...
                        {
                            j++;
                            std::cout << "Integer " << n << " has been input!\n\n";
                        }
                        else
                            std::cout << "\n\nInsert failed!\n\n";
                    }
